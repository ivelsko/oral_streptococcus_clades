...
san_prop <- primate_calc_filt.pca.varmet %>%
  ...
  ggplot(., aes(PC1, PC2, colour = Sanguinis, shape = Full, size = Full)) +
    geom_point() +
    scale_shape_manual(values = c(18,5,1,16,2,17,0,15,13,8,3,4,14)) +
...
ggsave("./06-publication/main_figures/Figure_8/primate_oral_pc12.pdf", plot = strep_pca, device = "pdf",
       scale = 1, width = 21, height = 7, units = c("in"), dpi = 300)

# for legends
# ggsave("./06-publication/main_figures/Figure_8/primate_oral_pc12_legends.pdf", plot = strep_pca, device = "pdf",
