...
# modified 02/09/2022 by Irina Velsko for the Strep clades project
################################################################################
...
#### SAMPLES ###################################################################
samplelist = pd.read_csv("/mnt/archgen/microbiome_calculus/strep_clades/03-preprocessing/hmp2012_suprapq_eager.tsv",
                         sep="\t")
LIBRARIES = samplelist['Library_ID'].unique().tolist()
SAMPLES = samplelist['Sample_Name'].unique().tolist()
################################################################################

###### Paths for all the eager2 input files ######
# /mnt/archgen/microbiome_calculus/strep_clades/03-preprocessing/hmp2012_suprapq_eager.tsv
# /mnt/archgen/microbiome_calculus/strep_clades/03-preprocessing/brito2016_eager.tsv
# /mnt/archgen/microbiome_calculus/Cameroon_plaque/03-preprocessing/all_data_combined/all_cmc_eager2_input.tsv
# /mnt/archgen/microbiome_calculus/Cameroon_plaque/03-preprocessing/all_data_combined/hmp_pq_eager2.tsv
# /mnt/archgen/microbiome_calculus/strep_clades/03-preprocessing/fellowsyates2021_eager.tsv
#############################################
...
def list_bamfiles(wildcards):
    ...
    return " ".join([f"/mnt/archgen/microbiome_calculus/strep_clades/03-preprocessing/hmp2012_suprapq/eager2/mapping/bwa/{wildcards.library}_{seqtype}.mapped.bam"
                     for seqtype in seqtypes])

################################################################################

###### Paths for all the reads ######
# /mnt/archgen/microbiome_calculus/strep_clades/03-preprocessing/hmp2012_suprapq/eager2/
# /mnt/archgen/microbiome_calculus/strep_clades/03-preprocessing/brito2016/eager2/
# /mnt/archgen/microbiome_calculus/Cameroon_plaque/03-preprocessing/all_data_combined/eager2/
# /mnt/archgen/microbiome_calculus/Cameroon_plaque/03-preprocessing/all_data_combined/hmp_pq_eager2/
# /mnt/archgen/microbiome_calculus/strep_clades/03-preprocessing/fellowsyates2021/eager2/
#############################################
