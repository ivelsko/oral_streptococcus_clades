...
rule all:
    input: 
        expand("out_anc_calc/{sample}.kraken2.gtdb.output.tsv", sample=SAMPLES.keys()),
        expand("out_anc_calc/{sample}.kraken2.gtdb.report_mpa.tsv", sample=SAMPLES.keys())

rule kraken_classify:
    output:
        outfmt = "out_anc_calc/{sample}.kraken2.gtdb.output.tsv",
        repfmt = "out_anc_calc/{sample}.kraken2.gtdb.report_mpa.tsv"
