################################################################################
# Run RRAP on strep_clade modern calculus samples, just JAE006
#
...
rule bowtie2_alignment:
    output:
        touch("rrap_test_r0.done")
    message: "Run run RRAP on modern calc"
    params: 
        fastq = "/mnt/archgen/microbiome_calculus/strep_clades/04-analysis/gmgc_mapping/mod_input_path_one.tsv",
    ...
    shell:
        ...
        rrap -i {params.fastq} \
             -rg {params.catref} \
             -o /mnt/archgen/microbiome_calculus/strep_clades/04-analysis/gmgc_mapping/rrap/output_test_r0 \
